...
let eveAppleCount: Int = /*Your code here (Replace -1 with your solution)*/ applesDict["Eve"] ?? 4
...
let calAndDanAppleCount = /*Your code here (Replace -1 with your solution)*/(applesDict["Cal"] ?? 3) + (applesDict["Dan"] ?? 5)
...
var frequencyDict: [Character: Int] = [:] //empty dictionary

var mostFrequentChar: Character = "?"

// Your code here
for char in myString.lowercased(){
    if let value = frequencyDict[char]{ //handles seeing letter for first time
